...
const AddProduct = () => {
  ...
  const validateForm = () => {
    ...
    else if (parseInt(formData.stock) < 0) errors.stock = "Stock cannot be negative";
    if (!formData.category) errors.category = "Category is required";
    if (!isEditMode && formData.images.length === 0) errors.images = "At least one image is required";
  ...
  const getImageSource = (file) => (file instanceof File ? URL.createObjectURL(file) : file.url || file);
      ...
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="productStock" className="block text-gray-700 mb-2">
                Stock
              </label>
              <input
                id="productStock"
          ...
          {/* Upload Box */}
          <div>
            <label className="block text-gray-700 mb-2">Upload Images (Max 3)</label>
            ...
            >
              <p className="text-gray-600 font-medium">Click to upload or select files</p>
              <p className="text-sm text-gray-400 mt-1">You can upload up to 3 images (jpg, png)</p>
              <input
                id="fileInput"
                type="file"
                accept="image/*"
